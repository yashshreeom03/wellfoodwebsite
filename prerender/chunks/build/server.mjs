import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, ref, provide, createElementBlock, defineAsyncComponent, computed, unref, h, Suspense, nextTick, mergeProps, watch, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/vue/index.mjs';
import { createHooks } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/h3/dist/index.mjs';
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, useRoute as useRoute$1, RouterView } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/defu/dist/defu.mjs';
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/ufo/dist/index.mjs';
import emailjs from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/emailjs-com/cjs/index.js';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  ...
  },
  {
    name: "Career",
    path: "/Career",
    component: () => import('./Career.vue.mjs')
  },
  {
    name: "Company",
    path: "/Company",
    component: () => import('./Company.vue.mjs')
  },
  {
    name: "Contact",
    path: "/Contact",
  ...
  },
  {
    name: "Technology",
    path: "/Technology",
    component: () => import('./Technology.vue.mjs')
  },
  {
    name: "CareerDetail",
    path: "/CareerDetail",
    component: () => import('./CareerDetail.vue.mjs')
  },
  {
    name: "projectsDetail",
    path: "/projectsDetail",
    component: () => import('./projectsDetail.vue.mjs')
  }
];
...
const plugins = [
  ...
  email_0dWB39CP7aIGQM1eT8UcaMet7NEdPagKoZWZ4QsFhyU,
...
export { useRuntimeConfig as a, useRouter as b, useNuxtApp as c, nuxtLinkDefaults as d, navigateTo as n, resolveRouteObject as r, server as s, useHead as u };
