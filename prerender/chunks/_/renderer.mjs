import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/h3/dist/index.mjs';
import { joinRelativeURL, joinURL, withoutTrailingSlash } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/unhead/dist/utils.mjs';
import { toValue, isRef, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/vue/index.mjs';
import { renderToString } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/vue/server-renderer/index.mjs';
import { a as useRuntimeConfig, b as useStorage, d as defineRenderHandler, g as getRouteRules, u as useNitroApp } from './nitro.mjs';
import { stringify, uneval } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/devalue/index.js';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/2025-04-04/wellfoodwebsite/node_modules/unhead/dist/plugins.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/shreeom_website/favicon.ico"}],"style":[],"script":[],"noscript":[]};
